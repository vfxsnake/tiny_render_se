...
| 5 | Better camera | In progress (pipeline composed and rendering; regression A/B against the spike passes, basis-as-rows confirmed on screen; builder tests next) |
| 6 | Shading | Planned |
