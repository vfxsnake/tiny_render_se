...
| 5 | Better camera | In progress (all three builders written — `lookAt`, `viewport`, `perspective`; wiring + regression A/B next) |
| 6 | Shading | Planned |
