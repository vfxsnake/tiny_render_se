...
**As of 2026-07-29 — Lesson 3 (Hidden face removal / z-buffer) in progress: an OBJ model now renders solid in the live window, with the depth-ordering artifacts the z-buffer exists to fix; the depth-aware rasterizer rewrite is next.**
